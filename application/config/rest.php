...
|--------------------------------------------------------------------------
|
| Is login required and if so, which usuarios store do we use?
|
| '' = use config based usuarios, 'ldap' = use LDAP authencation
|
*/
...
|			$config['auth_override_class_method']['accounts']['usuarios'] = 'basic';
|
| Here 'deals' and 'accounts' are controller names, 'view', 'insert' and 'usuarios' are methods within. (NOTE: leave off the '_get' or '_post' from the end of the method name)
