        ...
        if ($username && $pass) {
            ...
            if ($user) {
                ...
                if ($user->password == $encryptedPass) {
                    ...
                    $this->response(array('result' => 'OK', 'Session' => $new_session, 'user_geo' => $user->bool_geo, 'location_geo_permission' => $user->bool_permitir_geo_ubicaciones), 200);
                } else {
            ...
            if ($current_session) {
                ...
                if ($new_session) {
                    $user = $this->user_model->getBy("id", $current_session->fk_user, $countryId);
