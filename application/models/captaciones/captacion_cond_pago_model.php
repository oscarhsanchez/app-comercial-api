...
class captacion_cond_pago_model extends CI_Model {
    ...
    private function getAssignedQuery($entityId, $userPk, $state, $lastTimeStamp) {
        ...
        $q = " SELECT DISTINCT cliente_cond_pago.*
             ...
             AND (r_usu_cap.updated_at > '".$lastTimeStamp."' OR clientes.updated_at > '".$lastTimeStamp."' OR cliente_cond_pago.updated_at > '".$lastTimeStamp."' )
    ...
    /**
     * Funcion que devuelve las condiconies de pago de los clientes de captacion
     * asignados a un usuarios (Vendedor o repartidor)
