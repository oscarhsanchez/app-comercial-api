...
require_once(APPPATH.ENTITY_IMAGEN_INCIDENCIA);
require_once(APPPATH.GENERIC_MODEL);


/**
 *
 * @Table "imagenes_incidencias"
 * @Entity "ImagenIncidencia"
 * @Country true
 * @Autoincrement true;
 *
 */
    ...
    function createImagen($entity, $array, $countryId) {
        ...
        if ($entity) {
            ...
            if ($dbEntity) {
                ...
                $entity->url = INCIDENCIAS_IMAGES_URL . "/";
                $entity->path = INCIDENCIAS_IMAGES_PATH . "/";
                $entity->estado = 1;
