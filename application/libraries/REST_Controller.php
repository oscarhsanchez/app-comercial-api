...
abstract class REST_Controller extends CI_Controller
{
	...
	*/
	 ...
	 * Detect API Key
	 *
	 * See if the usuarios has provided an API key
	 *
	 * @return boolean
	 */
	...
	protected function _perform_ldap_auth($username = '', $password = NULL)
	{
		...
		if (( $user_dn = ldap_get_dn($ldapconn, $entry_id)) == false) {
			log_message('error', 'LDAP Auth: failure, usuarios-dn could not be fetched');
			return false;
		}

		// User found, could not authenticate as usuarios
	...
	/**
	 * Check if the usuarios is logged in.
	 *
	 * @param string $username The usuarios's name
	 * @param string $password The usuarios's password
	 * @return boolean
	 */
	...
	protected function _prepare_digest_auth()
	{
		...
		// again if none given or if the usuarios enters wrong auth information.
