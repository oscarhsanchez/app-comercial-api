...
class Codebird
{
     ...
     * Always use this method unless you're working with multiple authenticated usuarios at once
     *
    ...
    protected function _detectMethod($method, $params)
    {
        ...
        $httpmethods['GET']  = array(
            ...
            'usuarios/show',
            'usuarios/search',
            'usuarios/contributees',
            'usuarios/contributors',
            'usuarios/profile_banner',

            // Suggested Users
            'usuarios/suggestions/:slug',
            'usuarios/suggestions',
            'usuarios/suggestions/:slug/members',
