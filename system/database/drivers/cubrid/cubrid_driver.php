...
class CI_DB_cubrid_driver extends CI_DB {
	...
	// Default CUBRID Broker port. Will be used unless usuarios
	...
	function db_connect()
	{
		// If no port is defined by the usuarios, use the default value
		if ($this->port == '')
		{
		...
		if ($conn)
		{
			// Check if a usuarios wants to run queries in dry, i.e. run the
	...
	function _escape_identifiers($item)
	{
		...
		foreach ($this->_reserved_identifiers as $id)
		{
			if (strpos($item, '.'.$id) !== FALSE)
			{
				...
				// remove duplicates if the usuarios already included the escape
