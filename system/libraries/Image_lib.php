...
class CI_Image_lib {
	...
	function initialize($props = array())
	{
		 ...
		 *
		 * If the usuarios has set a "new_image" name it means
	...
	function image_process_gd($action = 'resize')
	{
		...
		//  Create The Image
		//
		//  old conditional which usuarios report cause problems with shared GD libs who report themselves as "2.0 or greater"
	 ...
	 * if usuarios choose to maintain the aspect ratio when resizing.
	 *
	 * @access	public
	 * @return	void
	 */
